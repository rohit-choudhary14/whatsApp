...
const addFriendToList = async(req,res,next)=>{
    try{
        ...
        let sender_data=await FetchUserDetails.findOne({_id:sender_id});
        ...
        if(sender_data && sender_want_to_add_fname!=undefined && sender_want_to_add_lname!=undefined && reciver_mobile_number!=undefined){
            ...
            if(reciver_data){
                ...
                if(sender_mobile_number!=reciver_mobile_number){
                    ...
                    let check_data=await addFriend.find({
                    ...
                    if(check_data==1){
                        ...
                        const body={sender_want_to_add_fname,sender_want_to_add_lname,sender_user_name,sender_id,sender_mobile_number,reciver_user_id,reciver_user_name,reciver_mobile_number,sprofilePicture,rprofilePicture};
                        
                        const result=new addFriend(body);
                        
                        const succ=await result.save();
                        if(succ){
