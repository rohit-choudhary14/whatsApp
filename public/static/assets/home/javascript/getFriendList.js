export function initgetFriendList(closeLoader){
    async function getFreiendList(){
      try{
                        ...
                        result.forEach(element => {
                          ...
                          if(element.friend_status==1){
                            ...
                            newDiv.innerHTML=`
                              ...
                              ${element.reciver_user_name}
                              </p>
                              </div>
                              <div>
                                <button   style='border: none;background: #008069;color: white;padding: 0.3rem;border-radius: 4px;'>${button}</button>
